...
<div data-expander="list_links_{{ $index }}">
    ...
    <div class="expander__body">
        ...
        <x-form.hidden
            ...
            value="{{ $data['aid'] }}"
            :data="[
                'field-context' => 'items.list-link_'. $index,
            ]"
        />
        ...
        <div class="flex__col">
            ...
            <div class="button" data-action="add" data-component="items.list-link" data-target-container="item_{{ $data['aid'] }}" data-field-set="{{ $index }}" data-multi-language="true">
