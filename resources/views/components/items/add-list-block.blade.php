...
<div class="accordion" data-item="item_{{ $form_data['aid'] }}_{{ $index }}" data-index="{{ $index }}">
    ...
    <div class="accordion__body">
        <div class="flex__col">
            ...
            <x-form.text
                name="sections[{{ $locale }}][{{ $form_data['aid'] }}][content][{{ $index }}][subtitle]"
                value="{{ $form_data['item']['subtitle'] ?? '' }}"
                title="Подзаголовок блока"
            />

            <x-form.ckeditor
                name="sections[{{ $locale }}][{{ $form_data['aid'] }}][content][{{ $index }}][content]"
            ...
            <div class="file__panel" data-file="{{ $form_data['aid'] }}_{{ $index }}">
                ...
                <x-form.hidden
                    class="file__input"
                    name="sections[{{ $locale }}][{{ $form_data['aid'] }}][content][{{ $index }}][image]"
